...
public class StaticData {
    public static Profile createSimpleProfile() {
        ...
        employess.add(new Employments(999, "tester", "020", false));
    ...
    public static DrivingReport createSimpleDrivingReport() {
        DrivingReport result = new DrivingReport("purpose", "999", "1", "extra here.", false, true, false, false, new DateTime(), new DateTime(), 6000, 6000);
